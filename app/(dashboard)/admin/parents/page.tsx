...
import { AdminParentsTableWrapper } from "@/components/admin/AdminParentsTableWrapper";
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        ...
        description="Gérez les parents d'élèves et leurs liaisons avec les enfants"
        icon={Heart}
        actions={
      ...
      <EnhancedCard
        ...
        description="Gérez tous les parents d'élèves, leurs informations et leurs liaisons avec les enfants"
        icon={Heart}
        gradient={true}
        className="shadow-xl border-0"
      >
        <AdminParentsTableWrapper initialParents={parents} />
      </EnhancedCard>
    </div>
  );
}